...
func TestResolveVineVersion(t *testing.T) {
	for _, test := range []struct {
		...
		{name: "explicit default", version: "v0.15.0", expected: "v0.15.0"},
...
func TestResolveVineVersionRejectsInvalidVersion(t *testing.T) {
	for _, version := range []string{"v0.14.0", "v0.14.1", "v0.15.0-rc.1", "0.15.0", "v0.13.1", "v0.13.0", "v0.12.0", "v0.10.1", "v-invalid"} {
